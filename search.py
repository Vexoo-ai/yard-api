...
def process_and_rank_results(all_results, query):
    ...
    for result in combined_results:
        ...
        semantic_similarity_snippet = cosine_similarity(
            [query_embedding], [snippet_embedding])[0][0]
        semantic_similarity_title = cosine_similarity(
            [query_embedding], [title_embedding])[0][0]
